...
| Red teaming | The scan sends harmful prompts on purpose (violence, hate and unfairness). Confirm that your organization permits it; otherwise teams skip Level 3 section 3. Its report opens only in the classic portal view: New Foundry's **Red team** tab lists only runs created with the newer evaluations API. |
