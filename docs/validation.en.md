...
**Quick view:** after `compare`, `python scripts/workshop.py summary --labels baseline improved` prints the per-model values below, your reviewed case's V2 result, and the failed rows. It only reads these files.
